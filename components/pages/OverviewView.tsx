  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300 ease-out">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between border-b border-white/[0.08] pb-6">
        <div>
          <div className="mb-2 flex items-center gap-2">
            <span className="size-2 rounded-full bg-[#ccff00] shadow-[0_0_8px_#ccff00] animate-pulse" />
          ...
          <p className="mt-1 text-xs text-white/50 sm:text-sm">
            Real-time metric breakdown for Iron District PK gym revenue & athlete activity.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-2 rounded-xl bg-[#ccff00] px-4 py-2.5 text-xs font-bold text-black shadow-[0_0_20px_rgba(204,255,0,0.2)] transition-all hover:bg-[#dcff63] active:scale-95"
          >
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-[#0d100f] p-5 shadow-xl transition hover:border-white/20">
          <div className="flex items-center justify-between pb-4 border-b border-white/[0.06]">
            <div className="flex items-center gap-3">
              <div className="flex size-10 items-center justify-center rounded-xl bg-[#ccff00]/10 text-[#ccff00] border border-[#ccff00]/20">
            ...
            <span className="text-2xl font-black text-[#ccff00]">{collectionRate}%</span>
          </div>
          ...
          <div className="mt-5 space-y-4">
            ...
            <div className="h-3 w-full overflow-hidden rounded-full bg-white/10 p-0.5">
              <div
                className="h-full rounded-full bg-gradient-to-r from-[#ccff00] to-emerald-400 shadow-[0_0_12px_#ccff00] transition-all duration-500"
            ...
            <div className="grid grid-cols-2 gap-3 pt-2 text-xs">
              <div className="rounded-xl border border-white/[0.05] bg-white/[0.02] p-3">
                ...
                <p className="mt-1 font-extrabold text-[#ccff00] text-sm">{formatPKR(activeRevenue)}</p>
              </div>
              <div className="rounded-xl border border-white/[0.05] bg-white/[0.02] p-3">
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-[#0d100f] p-5 shadow-xl transition hover:border-white/20">
          ...
          <div className="mt-5 space-y-3">
            ...
            <div className="flex items-center justify-between rounded-xl border border-[#ccff00]/20 bg-[#ccff00]/[0.03] p-3.5">
              <div className="flex items-center gap-3">
                <span className="size-3 rounded-full bg-[#ccff00] shadow-[0_0_8px_#ccff00]" />
                <div>
                  <p className="text-xs font-bold text-[#ccff00]">Treadmill Pro</p>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 rounded-2xl border border-white/[0.08] bg-[#0a0d0b] p-5">
        ...
        >
          <Users className="size-4 text-[#ccff00]" />
